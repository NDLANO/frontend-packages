...
class Swipe extends React.Component<Props, {}> {
  ...
  public render() {
    ...
    const newProps: React.HTMLAttributes<any> = {
      ...
      onTouchStart: this.props.detectTouch
        ? start
        : (_: React.TouchEvent<any>): void => {},
      onTouchMove: this.props.detectTouch
        ? move
        : (_: React.TouchEvent<any>): void => {},
      onTouchEnd: this.props.detectTouch
        ? end
        : (_: React.TouchEvent<any>): void => {},
      onMouseDown: this.props.detectMouse
        ? start
        : (_: React.MouseEvent<any>): void => {},
      onMouseMove: this.props.detectMouse
        ? move
        : (_: React.MouseEvent<any>): void => {},
      onMouseUp: this.props.detectMouse
        ? end
        : (_: React.MouseEvent<any>): void => {},
