...
export default [
  ...
  { desktop: markedsfoering, mobile: markedsfoering, name: 'Markedsføring og ledelse' },
  { desktop: samfunnsfag, mobile: samfunnsfag, name: 'Samfunnsfag' },
  { desktop: serviceSamferdsel, mobile: serviceSamferdsel, name: 'Service og samferdsel' },
];
