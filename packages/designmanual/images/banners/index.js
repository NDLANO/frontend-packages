...
export default [
  ...
  { desktop: ByggOgAnleggsteknikk, mobile: ByggOgAnleggsteknikk, name: 'Bygg- og anleggsteknikk' },
  ...
  { desktop: HelseOgOppvekst, mobile: HelseOgOppvekst, name: 'Helse og oppvekst' },
  ...
  { desktop: Markedsføring, mobile: Markedsføring, name: 'Markedsføring og ledelse' },
  { desktop: Matematikk, mobile: Matematikk, name: 'Matematikk' },
  { desktop: MedieuttrykkOgMediesamfunnet, mobile: MedieuttrykkOgMediesamfunnet, name: 'Medieuttrykk og mediesamfunnet' },
  { desktop: MedieOgInformasjonskunnskap, mobile: MedieOgInformasjonskunnskap, name: 'Medie- og informasjonskunnskap' },
  { desktop: Naturbruk, mobile: Naturbruk, name: 'Naturbruk' },
  { desktop: ServiceOgSamferdsel, mobile: ServiceOgSamferdsel, name: 'Service og samferdsel' },
  { desktop: SalgServiceOgSikkerhet, mobile: SalgServiceOgSikkerhet, name: 'Salg, service og sikkerhet' },
