...
class FootnotesExample extends Component {
  ...
  render() {
    return (
      <div>
        <p>
          Når du pitcher, blir idéen og historien i den filmen du planlegger å
          lage, tydeligere for både deg selv og dem du eventuelt jobber sammen
          med i klassen.{' '}
          <span id="ref1" className="c-footnotes__ref">
            Målgruppen for Hansaspillet er både fastboende og turister. Pitching
        ...
        <p>
          <span id="ref2" className="c-footnotes__ref">
            ...
            samarbeidsprosjekter for å løfte frem Munchs ukjente tekstarv.{' '}
            <sup>
