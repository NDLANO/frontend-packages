    ...
    <ArticleWrapper id="mainContentId" modifier={contentTypes.ASSESSMENT_RESOURCES}>
      <LayoutItem layout="center">
        <ArticleHeaderWrapper competenceGoals={<CompetenceGoalListExample />} competenceGoalTypes={['LK20', 'LK06']}>
          <ArticleTitle icon={<AssessmentResourcesBadge background size="large" />} label="Vurderingsressurs">
            Portal for vurdering, engelsk fellesfag
          </ArticleTitle>
          <ArticleIntroduction>
            På disse sidene har vi samlet ressurser som kan støtte elever og lærere i arbeidet med vurdering. Ressursene
            her kan brukes til egenevaluering av elevene og i dialog mellom elev og lærer.
          </ArticleIntroduction>
        </ArticleHeaderWrapper>
      </LayoutItem>
      <LayoutItem layout="center">
