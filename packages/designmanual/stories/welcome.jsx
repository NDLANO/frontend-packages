...
const Welcome = () =>
  <div style={{marginTop: '30px'}}>
    ...
    <StoryBody>
      ...
      <p>Designmanualen inneholder retningslinjer for formatering,
      visuelt uttrykk, interaksjon, og innholdselementer.</p>
      <p>En del lenker, knapper og lignende funksjonalitet vil ikke ha reelt
      innhold. Dette er ment som eksempler til videre utvikling oppimot APIer og
