...
export const stories = {
  ...
  H5P: {
    ...
    body: [
      { 
        type: 'text',
        content: 'Ønsker du å bruke eksisterende oppgaver vil du finne disse i listen. Du kan også søke deg fram eller filtrere listen for enklere finne det du leter etter.',
      },
      {
        type: 'text',
