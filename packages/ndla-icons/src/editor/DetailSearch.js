...
const DetailSearch = props => (
  <Icon
    ...
    <g>
      <polygon
        class="cls-1"
        points="27.7 17.7 20 17.9 19.8 10.2 19.8 9.9 17.8 9.9 17.8 10.2 18 17.9 10.3 18.1 10 18.1 10 20.1 10.3 20.1 18 19.9 18.2 27.6 18.2 27.9 20.2 27.9 20.2 27.6 20 19.9 27.7 19.7 28 19.7 28 17.7 27.7 17.7"
      />
      <path
        class="cls-1"
