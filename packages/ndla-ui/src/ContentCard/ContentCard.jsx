...
const ContentCard = ({ heading, images, description, type, url, isFilm, urlTarget }) => (
  <article {...classes()}>
    <SafeLink to={url} target={urlTarget} rel={urlTarget === '_blank' ? 'noreferrer noopener' : undefined} {...classes('link')}>
      <header>
