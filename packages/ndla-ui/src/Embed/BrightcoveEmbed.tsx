...
export const makeIframeString = (url: string, width: string | number, height: string | number, title = "") => {
  ...
  return `<iframe title="${urlOrTitle}" aria-label="${urlOrTitle}" src="${url}" width="${strippedWidth}" height="${strippedHeight}" allow="fullscreen" style="border: none;" scrolling="no" loading="lazy"></iframe>`;
};
