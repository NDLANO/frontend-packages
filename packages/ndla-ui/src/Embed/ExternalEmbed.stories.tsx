...
const metaData: OembedData = {
  oembed: {
    ...
    width: 560,
    height: 315,
    html: '<iframe src="https://embed.ted.com/talks/zahra_biabani_the_eco_creators_helping_the_climate_through_social_media" width="560" height="315" allow="fullscreen" style="border: none;" scrolling="no"></iframe>',
  },
};
