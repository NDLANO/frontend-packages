...
**Læringssti:** urn:resourcetype:learningPath <br/>
**Fagstoff:** urn:resourcetype:subjectMaterial <br/>
**Oppgaver og aktiviteter:** urn:resourcetype:tasksAndActivities <br/>
**Vurderingsressurs:** urn:resourcetype:reviewResource <br/>
**Ekstern læringsressurs:** urn:resourcetype:externalResource <br/>
**Kildemateriale:** urn:resourcetype:SourceMaterial <br/>
