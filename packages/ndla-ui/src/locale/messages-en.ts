...
const messages = {
  ...
  myNdla: {
    ...
    myPage: {
      ...
      loginText:
        'In order to use the My NDLA service you have to be a stundent or work at a school in a county that partakes in the NDLA collaboration. We ask you not to write offensive or personally sensitive information in text fields. Read our ',
