  ...
  myNdla: {
    ...
    myPage: {
      ...
      storageInfo: {
        ...
        text: 'When you wish to save a resource, you can do so by clicking the heart in the top left corner of the page. You will then get an option to store the resource in a folder',
      },
      folderInfo: {
