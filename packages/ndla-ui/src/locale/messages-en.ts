...
const messages = {
  ...
  myNdla: {
    ...
    share: 'Share selected from {{title}}',
    copyLink: 'Copy and share this link in Teams of Messenger:',
    copyCode: "Integrate this code on It's learning, One Note or your preffered LMS",
    preview: 'Preview',
    tags: '{{count}} tag',
