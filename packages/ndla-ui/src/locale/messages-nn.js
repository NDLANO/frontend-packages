...
const messages = {
    ...
    lti: {
        embed: 'Sett inn',
        notSupported: 'Det fungerte ikkje å sette inn innhaldet automatisk. Kopier kildekoden under for å sette inn på di side.',
    },
    searchPage: {
        ...
        searchResultListMessages: {
            ...
            noResultDescription: 'Vi har dessverre ikkje noko å tilby her. Om du vil føreslå noko innhald til dette området, kan du bruke Spør NDLA som du finn nede til høgre på skjermen.',
        },
        searchPageMessages: {
    ...
    welcomePage: {
        search: 'Søk',
        searchDisclaimer: 'Vi jobbar stadig med å forbetre oss! Har du kommentarer til søket, blir vi glad om du legg dei inn i «spør NDLA» nede i høgre hjørne.',
        resetSearch: 'Tøm søk',
        ...
        socialMedia: {
            heading: 'Følg oss',
            description: 'NDLA har mange facebook- og twitterkontoar. Finn den som passar for deg, og følg oss!',
            mainLink: {
                name: 'Følg oss',
            },
        },
    ...
    meta: {
        description: 'Kvalitetssikra fritt tilgjengelege nettbaserte læremiddel for videregåande opplæring',
    ...
    resource: {
        ...
        dialogText1: 'Når du lærar deg kjernestoffet skaffar du deg den kompetansen som beskrives i læreplanen for faget.',
        dialogText2: 'Tilleggsstoff er innhald i faget som du kan velje i tillegg til kjernestoffet. Gjennom tilleggsstoffet kan du fordjupe deg i et emne eller tilnærma deg emnet på en anna måte.',
        showLess: 'Vis mindre',
        showMore: 'Vis mer',
    ...
    license: {
        ...
        h5p: {
            ...
            description: 'Du finn retningslinjene for bruk av innholdet i H5P-elementet.',
    ...
    footer: {
        ...
        vision: 'NDLA sin visjon er å lage gode, opne digitale læremiddel for alle faga i vidaregåande opplæring og støtte opp om elevar og lærarar i aktivt og deltakande læringsarbeid.',
    ...
    ndlaFilm: {
        ...
        about: {
            ...
            text: 'NDLA film er ei nettbasert filmteneste for elevar og lærarar i videregåande skule. Her finn du spelefilmar, kortfilmar, dokumentarfilmar og TV-seriar.',
        },
        search: {
    ...
    filmfrontpage: {
        ...
        moreAboutNdlaFilm: {
            header: 'NDLA Film',
            firstParagraph: 'Filmane i filmtenesta er henta frå norsk og internasjonal filmarv og er kobla mot læreplaner i fleire fag. Dei er utvalde av redaksjonene til NDLA i samarbeid med Norgesfilm AS.',
            secondParagraph: 'Du kan sjå filmane om du er kobla til Internett via datamaskina, nettbrettet eller smarttelefonen din. Vi har gjort jobben med rettigheitsklarering og betaling. Alt du treng å gjere, er å trykke play.',
            thirdParagraph: 'Filmane er copyrightmerka. Dei kan fritt avspelast på ndla.no, men ikkje lastes ned eller distribuerast vidare i andre publikasjoner. Alle rettighetshavere honoreres for dei avspelinger som gjeres.',
            secondHeading: 'Bruk film i undervisninga',
            fourthParagraph: 'Ein film fortel historier på måter som engasjerer og rører oss. I film brukast nokre av dei mest effektive visuelle verkemidla som finst; levande bilete og lyd. Ein god film kan vise sider ved samtida og gje visjonar om framtida eller kommentere fortida. Difor kan film ofte gje oss betre forståing av hendingar, kulturmøter og historie enn ein fagtekst.',
            fifthParagraph: 'Ved å sjå film blir elevane betre rusta til å lese filmspråket, slik at filmen får ein verdi ut over det reint underholdningsmessige. Den generelle delen av læreplanen legg vekt på at elevane skal møte kunst og kulturformer som stimulerer, inspirerer eiga skaparevne, og fremmar etisk orienteringsevne og estetisk sans.',
