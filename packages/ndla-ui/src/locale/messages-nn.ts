...
const messages = {
  ...
  myNdla: {
    ...
    share: 'Del valde frå {{title}}',
    copyLink: 'Kopier og del denne lenka i til dømes teams eller messenger:',
    copyCode: "Integrer koden på It's learning, One Note eller din føretrekte LMS",
    ...
    confirmDeleteTag: 'Er du sikker på at du vil sletta emneknagg? Denne handlinga kan ikkje endrast.',
