...
const messages = {
  ...
  license: {
    ...
    files: {
      heading: 'Slik gjenbruker du filer fra artikkelen',
  ...
  frontpageMenu: {
    ...
    cursorText: 'Se smakebiter fra fag som under utvikling.',
  },
  navigation: {
  ...
  myNdla: {
    ...
    share: 'Del valgte fra {{title}}',
    copyLink: 'Kopier og del denne lenken i for eksempel teams eller messenger:',
    copyCode: "Integrer koden på It's learning, One Note eller din foretrukne LMS",
