...
storiesOf('Brukertest', module)
  ...
  .add('Journalistikk', () => (
    <PageContainer>
      ...
      <OneColumn>
        <article className="c-article">
          <h1>Journalistikk</h1>
          <section className="c-article__byline"><span className="c-article__authors">Ragnhild Risholt Kleppe, Ragna Marie Tørdal</span> –&nbsp;<span className="c-article__date">Sist oppdatert: 09/03/2016</span></section>
          <section className="article_introduction"><p className="article_introduction">Journalistikk er informasjon om noe som faktisk finnes eller har hendt, og som formidles på en upartisk måte i en uavhengig nyhetskanal. Det er også en profesjon, det vil si et yrke som utøves av journalister.</p>
          </section>
          <div>
            <section>
  ...
  .add('Oversikt over journalistiske sjangre', () => (
    <PageContainer>
      <MastheadExample />
      <OneColumn>
        <article className="c-article"> <h1>Oversikt over journalistiske sjangre</h1><section className="c-article__byline"><span className="c-article__authors">Ragnhild Risholt Kleppe</span> –&nbsp;<span className="c-article__date">Sist oppdatert: 02/12/2016</span></section><section className="article_introduction"><p className="article_introduction">Det finnes mange ulike subjektive og objektive sjangre, og det er ikke uvanlig at ulike betegnelser brukes om samme sjanger. I tillegg er sjangrene i stadig endring.</p></section><div><section>
