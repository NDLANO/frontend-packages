...
- Extremely large pieces of css
  - Article styling
  - Code block styling (for now). TODO: Consider moving this.
...
The styled-system approach is extremely flexible, but also comes at a cost. According to benchmarks (TODO: add link), that cost is about a 30% drop in performance. We did not want to compromise on that!
