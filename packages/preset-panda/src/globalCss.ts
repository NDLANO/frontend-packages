...
export const globalCss = defineGlobalStyles({
  ...
  // Some headers don't have a styling class, and therefor no margin. Handled with generic fallbacks in old global css, and now temporarily handled by these selectors.
  "h1:not([class])": {
